...
<body class="p-4">
    <div class="container">
        ...
        <a href="<?= base_url('admin/penggajian/create') ?>" class="btn btn-primary mb-3">Tambah Penggajian</a>
                    ...
                    <?php foreach ($penggajian as $row): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('admin/penggajian/edit/'.$row['id_anggota']) ?>" class="btn btn-warning btn-sm">Edit</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
