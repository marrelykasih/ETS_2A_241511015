...
<div class="container">
  ...
  <a href="<?= base_url('admin/penggajian/create') ?>" class="btn btn-primary mb-3">Tambah Anggota</a>
    ...
    <?php foreach ($penggajian as $row): ?>
      <tr>
        ...
        <td>
          ...
          <a href="<?= base_url('admin/penggajian/delete/'.$row['id_anggota']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Hapus semua data gaji anggota ini?')">Hapus</a>
        </td>
      </tr>
    <?php endforeach; ?>
  </tbody>
