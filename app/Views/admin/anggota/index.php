                ...
                <?php if (!empty($anggota)): ?>
                    <?php foreach ($anggota as $row): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('admin/anggota/edit/'.$row['id_anggota']) ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="<?= base_url('admin/anggota/delete/'.$row['id_anggota']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus data ini?')">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
